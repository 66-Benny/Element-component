  ...
  <basic-dialog :visible.sync="innerVisible"
    ...
    <div class="bank-select bank-common-select-dialog">
      ...
      <scm-table ref="multipleTable"
        ...
        <scm-table-column label="资产类别描述"
                          prop="zasstNm"></scm-table-column>
        <scm-table-column label="资产类别"
                          prop="zasst"
...
const FETCH_DATA_ACTION = 'mdm/fetchAssetClass';
...
export default {
  ...
  computed: {
    ...StoreGlobalAPI.mapState({
      ...
      bank: state => state.mdm.assetClass,
    }),
    clearDisabled() {
